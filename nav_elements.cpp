...
bool elements::tab(const char* name, bool boolean)
{
    ...
    window->DrawList->AddText(tab_icons, 15.0f, temp, ImColor(1.0f, 1.0f, 1.0f, it_anim->second.text_opacity), name);
...
bool elements::subtab(const char* name, bool boolean)
{
    ...
    window->DrawList->AddRectFilled(ImVec2(rect.Max.x + 5, rect.Min.y + 9), ImVec2(rect.Max.x + 8, rect.Max.y - 9), ImColor(0.235f, 0.702f, 0.553f, it_anim->second.rect_opacity), 10.0f, ImDrawFlags_RoundCornersLeft);
