...
* The 0x1000-sized per-Memory memory buffers are contigious between MEMs in order.
* -- cMEMs
...
* -- pbData = buffer used for Memory.pb
* -- cMEMs
* -- pppMEMs = pointer to receive ppMEMs
* -- return
*/
...
* -- pbData = buffer used for Memory.pb except first/last if exists
* -- cMEMs
* -- pppMEMs = pointer to receive ppMEMs
* -- return
*/
